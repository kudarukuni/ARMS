	...
	<div class="main-wrapper">
		<h2>ASSET LIBRARY</h2>
							...
							<br><br><br><center>
								<table border="1">
									<th colspan="7"><font color="white">Asset Library Log</font></th>
										...
										<tr>
											<form action="includes/library.inc10.php" method="POST" class="signup-form" onsubmit="checkfields()">
			...
			<script>
				...
				{
					if (document.getElementById("ecnum").value == "" || document.getElementById("names").value == "" || document.getElementById("natid").value == "" || document.getElementById("borrowed").value == "" || document.getElementById("seria").value == "" || document.getElementById("librarian").value == "" || document.getElementById("dateborrowed").value == "" || document.getElementById("duedate").value == "" || document.getElementById("phone").value == "")
					{
			...
			<?php
				...
				$sql7 = "SELECT * FROM library1 WHERE duedate < '$today_date'";
				$result7 = mysqli_query($conn, $sql7);
				$resultCheck7 = mysqli_num_rows($result7);

				$sql19 = "SELECT COUNT(duedate) as 'expiredassets' FROM library1 WHERE duedate < '$today_date'";
			...
			<p>
				...
				<a href="assetregister1.php"><b><font size='3'>REGISTER AN ASSET NOW!!!</font></b></a>

				<form action="includes/library.inc12.php" method="POST" class="signup-form" onsubmit="checkfields2()">
					<br>
			...
			<?php
				$sql47 = "SELECT * FROM assetregister1";
				...
				if ($resultCheck47 > 0) 
				{
					...
					{
						echo '	<tr>
									<td><center>' . $row47['ass_id'] . '</center></td>
									<td>' . $row47['seria'] . '</td>
									<td>' . $row47['model'] . '</td>
									<td>' . $row47['dob'] . '</td>
									<td>' . $row47['sp'] . '</td>
