	...
	<div class="main-wrapper">
		<h2>VEHICLE MAINTAINANCE</h2>
							...
							<br><center>
								<table border="1">
									<th colspan="7"><font color="white">Maintainance Log</font></th>
										...
										<tr>
											<form action="includes/maintain1.inc.php" method="POST" class="signup-form" onsubmit="checkfields()">
												<td><input type="text" name="ecnum" id="ecnum"></td>
												<td><input type="text" name="regnum" id="regnum"></td>
			...
			<script>
				...
				{
					if (document.getElementById("ecnum").value == "" || document.getElementById("regnum").value == "" || document.getElementById("model").value == "" || document.getElementById("history").value == "" || document.getElementById("cost").value == "" || document.getElementById("repaired").value == "" || document.getElementById("fix").value == "")
					{
