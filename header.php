			...
			<ul>
				...
				<li>
					...
					<?php
						...
						{
							echo'<b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="register.php">REGISTRATION</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="maintain.php">MAINTANANCE</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="report.php">QUERY</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="analysis.php">ANALYSIS</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="confisticated.php">INVENTORY</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="library.php">LIBRARY</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="printform.php">PRINT FORM</a></b>';
						}
					?>
				...
				<?php
					...
					else
					{
						echo '	<form action="includes/login.inc.php" method="POST" onsubmit="checkfields()">
									...
									<button type="submit" name="submit1" style="cursor:pointer; display: block; margin: 0 auto; width: 17%;	height: 30px;	border: none; background-color: #222; font-family: arial; font-size: 16px; color: #fff;">LOGIN</button>
								</form>
