	...
	<section class="main-container">
		<div class="main-wrapper">
			...
			<?php
				...
				$sql8 = "SELECT dod FROM register WHERE mac = '$search'";
			...
			<?php	
				...
				{							
					...
					{
						$sql = "SELECT * FROM register WHERE mac = '$search'";
						$result = mysqli_query($conn, $sql);
						$resultCheck = mysqli_num_rows($result);

						if ($resultCheck < 1)
						{
							header("Location: report.php?report=macnotfound");
							exit();
						}
						else 
						{
						...
						$sql6 = "SELECT * FROM register WHERE mac = '$search'";
			...
			<?php
				...
				$sql2 = "SELECT SUM(sp) as 'spcost' FROM register WHERE mac = '$search'";
				$sql4 = "SELECT dob FROM register WHERE mac='$search'";
				$sql5 = "SELECT dod FROM register WHERE mac='$search'";
			...
			<?php
				...
				$sql0 = "SELECT SUM(cost) as 'sumcost' FROM maintain WHERE mac = '$search'";
			...
			<?php
				...
				$sql0 = "SELECT COUNT(cost) as 'countcost' FROM maintain WHERE mac = '$search'";
				$result0 = mysqli_query($conn, $sql0);
				$resultCheck0 = mysqli_num_rows($result0);
				$row0 = mysqli_fetch_array($result0);
