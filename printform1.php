...
<body>
	...
	<section class="main-container">
		<div class="main-wrapper">
			...
			<h2><center><a href="index3.php">COMPANY NAME (Pvt) Ltd.</a></center></h2>
			<h1><center><a href="index3.php">Head Office</a></center></h1>
		...
		<form action="includes/printform1.inc.php" method="POST" onsubmit="checkfields()">
			<p><center>
